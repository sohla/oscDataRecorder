...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="oscDataRecorder",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15oscDataRecorder11AppDelegate")
...
SWIFT_CLASS("_TtC15oscDataRecorder17AssetGridViewCell")
...
SWIFT_CLASS("_TtC15oscDataRecorder23AssetGridViewController")
@interface AssetGridViewController : UICollectionViewController <PHPhotoLibraryChangeObserver>
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
- (void)viewDidAppear:(BOOL)animated;
- (void)viewDidLayoutSubviews;
- (void)photoLibraryDidChange:(PHChange * _Nonnull)changeInstance;
@property (nonatomic, strong) PHFetchResult<PHAsset *> * _Nonnull assetsFetchResult;
@property (nonatomic, strong) AVAsset * _Nullable selectedAsset;
...
@property (nonatomic, readonly, strong) OSCServer * _Nonnull server;
- (void)viewDidLoad;
- (void)viewWillAppear:(BOOL)animated;
...
SWIFT_CLASS("_TtC15oscDataRecorder11PreviewView")
